...
- Repo structure: code, process knowledge, runtime state, and artifacts clearly
  separated.
- Knowledge privacy: this repo stays public, while operational docs,
  templates, assistant prompts/process instructions, and other sensitive
  knowledge live in a separate private repo and are surfaced through the app.
