...
- Use `data/actual_podcast_questions.csv` for actual asked-question phrasing and live follow-up style.
- Use `knowledge_base/question_playbook.md` as the source of truth for the house style:
  questions must be grounded in the guest's bio, topic, projects, claims, metrics, and tensions.
...
For each final question, add a short hidden prep note or bullet explaining what source fact caused it.

## Live Follow-Up Prompts

- Clarify terms:
- Confirm understanding:
- Compare options:
- Ask for concrete examples:
- Challenge premises gently:
...
Do not commit or push changes. Leave generated documents and moved inbox files
as local working tree changes for the DataOps review pipeline.
