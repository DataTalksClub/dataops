...
doc_type: sop
schema_version: 1
source: "Processes/Luma/Creating events (Webinar, Workshop and Podcast) on Luma_.docx"
tags:
  - luma
systems:
  - google-calendar
...
1.  The first thing you need to do is go to Luma’s website and under the “Calendar” tab click [“DataTalksClub events”](https://lu.ma/home/calendars)
    ...
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image17.jpg)
    <!-- sop-caption-start -->
...
2.  Once done, click the plus button right beside “Events”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image4.jpg)
    <!-- sop-caption-start -->
...
3.  Then, click “Create New Event”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image1.jpg)
    <!-- sop-caption-start -->
...
4.  Click on “Theme” and the Font (Default) and color (Gray).
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image15.jpg)
    <!-- sop-caption-start -->
...
5.  Enter the event details (Title, Event cover, schedule of the event, event location, description)
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image11.jpg)
    <!-- sop-caption-start -->
...
6.  In the “Event Description” add the details of the event.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image18.jpg)
    <!-- sop-caption-start -->
...
7.  At the bottom of the description add “​​​​​​[DataTalks.Club](http://datatalks.club/) is the place to talk about data. [Join our Slack community](https://datatalks.club/slack.html)!”. Then click on “Done”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image7.jpg)
    <!-- sop-caption-start -->
...
8.  If the event is sponsored, indicate it at the last part of the event description through this format:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image10.jpg)
    <!-- sop-caption-start -->
...
9.  Once done, click “Create Event” or “Update Event” (If you are editing the event already created)
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image2.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-end -->
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image5.jpg)
    <!-- sop-caption-start -->
...
10. On the Event tab, scroll down and click “Add Host” to add Alexey as the host and organizer of the event, and then select “Alexey Grigorev” (alexey.s.grigoriev@gmail.com).
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image14.jpg)
    <!-- sop-caption-start -->
...
11. Go to “Registration”, scroll down and under “Custom Questions”, add an additional question:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image9.jpg)
    <!-- sop-caption-start -->
...
12. Select “Options:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image3.jpg)
    <!-- sop-caption-start -->
...
13. In the Question, type in or paste:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image6.jpg)
    <!-- sop-caption-start -->
...
14. If an event is sponsored, we will add two more questions to ask if they want to share their emails with the sponsors and for the Company name of the registrants Follow the steps in number 11-14 and use the question:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image8.jpg)
    <!-- sop-caption-start -->
...
15. For the second question follow step 11 and select “Text”.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image13.jpg)
    <!-- sop-caption-start -->
...
16. In the Question, type in or paste:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image16.jpg)
    <!-- sop-caption-start -->
...
17. After creating/updating the event, make sure to manually add the event to the Google Calendar
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-webinar-workshop-and-podcast-on-luma/media/image12.jpg)
    <!-- sop-caption-start -->
