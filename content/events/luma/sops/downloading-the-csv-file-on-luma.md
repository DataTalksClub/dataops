...
doc_type: sop
schema_version: 1
source: "Processes/Luma/Downloading the CSV File on Luma.docx"
tags:
  - luma
systems:
  - luma
...
1.  The first thing you need to do is open the past event on Luma.
    ...
    ![](../../../images/luma/downloading-the-csv-file-on-luma/media/image3.jpg)
    <!-- sop-caption-start -->
...
2.  And then, click on “Manage Event”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/downloading-the-csv-file-on-luma/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  After, select “Guests” and click the download button.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/downloading-the-csv-file-on-luma/media/image1.jpg)
    <!-- sop-caption-start -->
