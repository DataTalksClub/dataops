...
doc_type: sop
schema_version: 1
source: "Processes/Luma/Creating Events on Google Calendar.docx"
tags:
  - luma
systems:
  - google-calendar
  ...
  - youtube
loom:
  - https://www.loom.com/share/f9ba7b4d8a024f9fa952a80f4060887a
related_docs: []
---
...
1.  On the [Google calendar](https://calendar.google.com/calendar/u/0/r), click the time and date of the event.
    ...
    ![](../../../images/luma/creating-events-on-google-calendar/media/image1.jpg)
    <!-- sop-caption-start -->
...
2.  Type the name of the event, select the event’s schedule (date and time). Click on “Time Zone”.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-on-google-calendar/media/image3.jpg)
    <!-- sop-caption-start -->
...
3.  Make sure that time zone is in Central European Time (CET), and click “OK”.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-on-google-calendar/media/image6.jpg)
    <!-- sop-caption-start -->
...
4.  Type in the DTC’s YouTube Channel link as the event’s corresponding location
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-on-google-calendar/media/image5.png)
    <!-- sop-caption-start -->
...
5.  And then, make sure to select “DataTalks.Club event” calendar
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-on-google-calendar/media/image2.jpg)
    <!-- sop-caption-start -->
...
6.  On the description, follow this format:
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-on-google-calendar/media/image4.png)
    <!-- sop-caption-start -->
...
7.  Once done, click “Save" and it should look like the image below.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/luma/creating-events-on-google-calendar/media/image7.jpg)
    <!-- sop-caption-start -->
