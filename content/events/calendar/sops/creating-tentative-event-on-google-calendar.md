...
doc_type: sop
schema_version: 1
source: "Processes/Events/Creating Tentative Event on Google Calendar.docx"
tags:
  - events
systems:
  - google-calendar
...
1.  On the Google calendar, click the time and date of the event.
    ...
    ![](../../../images/events/creating-tentative-event-on-google-calendar/media/image1.jpg)
    <!-- sop-caption-start -->
...
2.  And then, make sure to select “DataTalks.Club event” calendar
    <!-- sop-screenshot-start -->
    ![](../../../images/events/creating-tentative-event-on-google-calendar/media/image5.jpg)
    <!-- sop-caption-start -->
...
4.  Click “Save”.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/creating-tentative-event-on-google-calendar/media/image3.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/creating-tentative-event-on-google-calendar/media/image2.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/creating-tentative-event-on-google-calendar/media/image6.png)
    <!-- sop-caption-start -->
