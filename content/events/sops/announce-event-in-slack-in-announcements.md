...
doc_type: sop
schema_version: 1
source: "Processes/Events/Announce event in Slack in #announcements.docx"
tags:
  - events
systems:
  - google-calendar
...
1.  Open the DataTalksClub Slack, and click the “#announcement” channel.
    ...
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image4.jpg)
    <!-- sop-caption-start -->
...
2.  Once \#announcement channel is open, go to the [slack announcement template](https://docs.google.com/document/d/1sGv9tZY2DB1AqBMVWklZS-B-mzRTaB7VllAJBNmeoxo/edit?usp=sharing) and copy the language and emojis or you can copy the latest announcement on the \#announcement channel.
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image12.jpg)
    <!-- sop-caption-start -->
...
3.  Paste the copied language for announcement to the message box then edit the text based on the upcoming event.
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image1.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image8.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image3.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image2.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image11.jpg)
    <!-- sop-caption-start -->
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image5.jpg)
    <!-- sop-caption-start -->
...
4.  Add the banner photo for the event (usually the rectangular format). Click the (+) plus sign on the lower left corner and select “Upload from your computer”. Then, select the photo.
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image9.jpg)
    <!-- sop-caption-start -->
...
5.  After pasting and editing the text of the announcement you can hit enter or click the green arrow button.
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image10.jpg)
    <!-- sop-caption-start -->
...
7.  Make sure the file name is relevant to the event. To edit, click the three dots on the upper right of the image you uploaded and select “Edit file details”.
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image7.jpg)
    <!-- sop-caption-start -->
...
8.  Change the file name to anything relevant to the event. Then, click “Save changes.”
    ...
    <!-- sop-screenshot-start -->
    ![](../../images/events/announce-event-in-slack-in-announcements/media/image6.jpg)
    <!-- sop-caption-start -->
