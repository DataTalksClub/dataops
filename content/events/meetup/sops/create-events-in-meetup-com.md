...
doc_type: sop
schema_version: 1
source: "Processes/Events/Create events in Meetup.com.docx"
tags:
  - events
systems:
  - google-calendar
  ...
  - youtube
loom:
  - https://www.loom.com/share/bcfdb1aa999f4f16897d20b015dbafcf
related_docs: []
---
...
1.  The first thing you will need to do is go to "[www.meetup.com/home](https://www.meetup.com/home/?suggested=true&source=EVENTS)” click "Create event".
    [https://www.meetup.com/home/?suggested=true&source=EVENTS](https://www.meetup.com/home/?suggested=true&source=EVENTS)![](../../../images/events/create-events-in-meetup-com/media/image3.jpg)
...
2.  After, you can now fill in the necessary details or copy the details of the event you created on “[luma.com](https://lu.ma/calendar/manage/cal-kg9jR2UeDILH68H)”
    ...
    ![](../../../images/events/create-events-in-meetup-com/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  Paste the event name under the "Title (required)" on [Meetup.com](https://www.meetup.com/home/?suggested=true&source=EVENTS)
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image10.jpg)
    <!-- sop-caption-start -->
...
4.  After pasting the title, choose your date and time.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image11.jpg)
    <!-- sop-caption-start -->
...
5.  And click the drag-down button for the duration of the event.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image7.jpg)
    <!-- sop-caption-start -->
...
6.  To add a photo, select “upload photo”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image12.jpg)
    <!-- sop-caption-start -->
...
7.  Then, select your photo on your computer and click "open"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image8.jpg)
    <!-- sop-caption-start -->
...
8.  Crop your photo if needed and click "Save photo"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image1.jpg)
    <!-- sop-caption-start -->
...
9.  Once done, copy the description of the event from “Lu.ma”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image4.jpg)
    <!-- sop-caption-start -->
...
10. After, paste it under "Description" on Meetup.com
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image13.jpg)
    <!-- sop-caption-start -->
...
11. Don't forget to add the link to the slack community.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image15.jpg)
    <!-- sop-caption-start -->
...
12. For the location, click the “Online" and add the link
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image6.jpg)
    <!-- sop-caption-start -->
...
13. The next thing to do is un toggle the check button for the "Registration form"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image9.jpg)
    <!-- sop-caption-start -->
...
14. After reviewing your work, click "Publish"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image5.jpg)
    <!-- sop-caption-start -->
...
15. After clicking, select "Announce it now"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/create-events-in-meetup-com/media/image14.jpg)
    <!-- sop-caption-start -->
