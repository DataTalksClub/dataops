...
doc_type: sop
schema_version: 1
source: "Processes/Events/Fill in the “event” form in Airtable for adding events to our website.docx"
tags:
  - events
systems:
  - airtable
  ...
  - luma
loom:
  - https://www.loom.com/share/553e5bffaccb4e72b096e0adec018736
related_docs: []
---
...
1.  The first thing you will be doing is open the [events form](https://airtable.com/app7NCWvFj6Wz0ASm/shrAY1W58LlKGGq81). Then, enter the speaker's email and the event
    ...
    ![](../../../images/events/fill-in-the-event-form-in-airtable-for-adding-events-to-our-website/media/image5.png)
    <!-- sop-caption-start -->
...
2.  To enter the Event title, visit the event on Luma and click on “Copy Link” at the top.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/fill-in-the-event-form-in-airtable-for-adding-events-to-our-website/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  And then, go back to the form and paste the URL under "URL"
    <!-- sop-screenshot-start -->
    ![](../../../images/events/fill-in-the-event-form-in-airtable-for-adding-events-to-our-website/media/image3.png)
    <!-- sop-caption-start -->
...
4.  To proceed, select the event type, click on the drop down button and choose what kind of event.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/fill-in-the-event-form-in-airtable-for-adding-events-to-our-website/media/image1.jpg)
    <!-- sop-caption-start -->
...
5.  And lastly, pick the date of the event and select "Submit"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/events/fill-in-the-event-form-in-airtable-for-adding-events-to-our-website/media/image4.jpg)
    <!-- sop-caption-start -->
