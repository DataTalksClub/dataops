...
doc_type: sop
schema_version: 1
source: "Processes/Mailchimp newsletter/Getting campaign performance stats.docx"
tags:
...
1.  The first thing you need to do is open MailChimp.com. Under “Campaign” click “All campaign”
    ...
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image12.jpg)
    <!-- sop-caption-start -->
...
2.  After, find the newsletter and click “View report”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  To proceed, scroll down and then you can now locate the campaign performance stats.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image7.jpg)
    <!-- sop-caption-start -->
...
4.  For the email to the sponsor, use this [template](https://docs.google.com/document/d/1ipx5NTvNbN3U56HbXQlIynqb9GW7v9NGFgaN6s6_Ia4/edit?usp=sharing) that will serve as your guide in finding the stats.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image9.png)
    <!-- sop-caption-start -->
...
5.  In finding the total number of clicks on the link, view the section “Top links clicked” and select “View all links”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image13.jpg)
    <!-- sop-caption-start -->
...
6.  Then, find the link to the sponsor with its correspondent click performance
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image5.jpg)
    <!-- sop-caption-start -->
...
7.  To find the views of the newsletter, just hover your mouse towards “Opens” on the newsletter.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image1.jpg)
    <!-- sop-caption-start -->
...
8.  For the performance on Twitter, visit DataTalks.Club’s Twitter and find the sponsored announcement. Click the announcement.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image11.jpg)
    <!-- sop-caption-start -->
...
9.  After, click “View Twitter Analytics”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image3.jpg)
    <!-- sop-caption-start -->
...
10. Here, you can view the total views and clicks of the sponsored announcement.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image4.jpg)
    <!-- sop-caption-start -->
...
11. Lastly, to view the total views and clicks on LinkedIn, open DataTalks.Club’s LinkedIn and click on analytics and then “Updates”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image10.jpg)
    <!-- sop-caption-start -->
...
12. Scroll down and find the sponsored announcement and view the total clicks and views of the announcement.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image8.jpg)
    <!-- sop-caption-start -->
...
13. Once done, update the [spreadsheet](https://docs.google.com/spreadsheets/d/1-T8qkmShlFUrT2NmkI8Pi1NgUS9IunP6wO5-L79xe2s/edit#gid=1710801712) for the newsletter performance
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/mailchimp-newsletter/getting-campaign-performance-stats/media/image6.jpg)
    <!-- sop-caption-start -->
