---
title: "Preparing a Zip Archive with Invoices and Send Reports to the Accountant"
summary: "Prepare invoice file archives and send monthly bookkeeping reports to the accountant."
doc_type: sop
schema_version: 1
source: "Processes/Bookkeeping & Invoices/Preparing a Zip Archive with Invoices and Send Reports to the Accountant.docx"
tags:
  - bookkeeping-invoices
systems:
  - finom
loom:
  - https://www.loom.com/share/cb33e55cf0c04c0b8556befa3e7c9cf1
  - https://www.loom.com/share/9ef2fe91375249a6925ef53ef899d232
related_docs: []
---
...
1.  The first thing you need to do is open the [Bookkeeping spreadsheet](https://docs.google.com/spreadsheets/d/1jIBou5XvBY3uy7dsxDUVM4yiPZAgXUN5AZJN3bDJgHU/edit?usp=sharing).
    ...
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image10.jpg)
    <!-- sop-caption-start -->
...
2.  On [Finom](https://app.finom.co/en/signin?redirect=%2Fen%2Fmoney), go to “History” and over your mouse to “In/Out” and select “Money In”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image3.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
3.  To prepare the zip archive, go to dropbox and select “[\_dtc_paperwork](https://www.dropbox.com/home/_dtc_paperwork)” and select “invoices”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image6.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
4.  In the folder, select the invoice folder, right-click and select “Compress to Zip file”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image12.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
5.  And now, rename the file.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image14.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
6.  Then, move this zip file to “[\_dtc_paperwork](https://www.dropbox.com/home/_dtc_paperwork)” folder in dropbox
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image1.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
7.  After, open “income-invoices”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image2.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
8.  And copy the invoices with plus (+)
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image7.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
9.  And paste it on the same compressed zip.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image11.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
10. After, go to “invoices” and select the invoice files for that month and move them to the “processed” folder
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image9.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
11. Next, go to the “invoice-income”, select the invoice files for this month and move them to the “processed” folder.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image8.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
12. Once done, send the Reports to the Accountant. On Gmail, click “Compose” on Gmail and add the recipient of the email, cc Alexey and the subject
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image13.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
13. After, open the [bookkeeping spreadsheet](https://docs.google.com/spreadsheets/d/1jIBou5XvBY3uy7dsxDUVM4yiPZAgXUN5AZJN3bDJgHU/edit?usp=sharing), and copy the report for that month and paste it on the email.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image4.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
15. Once done, click “Send”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/bookkeeping-invoices/preparing-a-zip-archive-with-invoices-and-send-reports-to-the-accountant/media/image15.jpg)
    <!-- sop-caption-start -->
    This screenshot confirms the reporting handoff state. Look for the highlighted spreadsheet range, folder, archive, attachment, or upload control, then make sure the accountant receives the complete package.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
