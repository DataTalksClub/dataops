...
doc_type: sop
schema_version: 1
source: "Processes/Youtube/Adding videos from other channels to our playlist.docx"
tags:
  - youtube
systems:
  - loom
...
1.  First, click on the three-dotted button beside the video and select “Save to playlist”
    ...
    ![](../../../images/youtube/adding-videos-from-other-channels-to-our-playlist/media/image3.jpg)
    <!-- sop-caption-start -->
...
2.  Then, select the Playlist where you want to add the video.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/adding-videos-from-other-channels-to-our-playlist/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  For course playlists – After adding to the new playlist, make sure to rearrange the videos accordingly (in sequence).
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/adding-videos-from-other-channels-to-our-playlist/media/image1.jpg)
    <!-- sop-caption-start -->
