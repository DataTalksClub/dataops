...
doc_type: sop
schema_version: 1
source: "Processes/Youtube/Add timecodes to YouTube videos.docx"
tags:
  - youtube
systems:
  - loom
...
2.  Next, open DataTalks.Club’s Youtube channel and click on “YouTube studio”
    ...
    ![](../../../images/youtube/add-timecodes-to-youtube-videos/media/image3.jpg)
    <!-- sop-caption-start -->
...
3.  After, click “content"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/add-timecodes-to-youtube-videos/media/image4.jpg)
    <!-- sop-caption-start -->
...
4.  And then, click on the pen tool, right beside the video.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/add-timecodes-to-youtube-videos/media/image5.jpg)
    <!-- sop-caption-start -->
...
5.  Under "Description", paste the template along with the ChatGPT generated timecodes of the video.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/add-timecodes-to-youtube-videos/media/image2.jpg)
    <!-- sop-caption-start -->
...
6.  Copy the Youtube link and ask the guest to review the timecodes through gmail using this template [Open-source spotlight Asking for revisions, links and timecodes](https://docs.google.com/document/d/1_jJLDGSTuyRGz6fimgwJLBGyT_dVl_rfr8T50qIqwa8/edit?tab=t.0)
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/add-timecodes-to-youtube-videos/media/image1.png)
    <!-- sop-caption-start -->
...
7.  Lastly, make changes if needed and click "Save"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/youtube/add-timecodes-to-youtube-videos/media/image6.jpg)
    <!-- sop-caption-start -->
