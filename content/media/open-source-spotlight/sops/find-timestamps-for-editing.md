...
doc_type: sop
schema_version: 1
source: "Processes/Open-source spotlight/Find timestamps for editing_.docx"
tags:
...
1.  The first thing you need to do is open the zoom recorded video from Alexey.
    ...
    ![](../../../images/open-source-spotlight/find-timestamps-for-editing/media/image4.jpg)
    <!-- sop-caption-start -->
...
2.  Once done, click on “Chat Messages” on the upper right of your screen.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/find-timestamps-for-editing/media/image1.jpg)
    <!-- sop-caption-start -->
...
3.  Here, you can now see the different timestamps to be edited. But before that, you need to do some offset calculations.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/find-timestamps-for-editing/media/image6.jpg)
    <!-- sop-caption-start -->
...
4.  To proceed, open the offset calculation [spreadsheet](https://docs.google.com/spreadsheets/d/1MDJUjRur6wPYkPP6N7JzQw3kuUIaA82_gIBwbGi1t04/edit#gid=1793309730).
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/find-timestamps-for-editing/media/image3.jpg)
    <!-- sop-caption-start -->
...
5.  And then, enter the timecodes that need to be edited.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/find-timestamps-for-editing/media/image5.jpg)
    <!-- sop-caption-start -->
...
6.  After, use the timecode calculated to edit the video in the YouTube editor.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/find-timestamps-for-editing/media/image2.jpg)
    <!-- sop-caption-start -->
