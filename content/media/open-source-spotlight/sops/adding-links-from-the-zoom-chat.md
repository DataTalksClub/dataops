...
doc_type: sop
schema_version: 1
source: "Processes/Open-source spotlight/Adding links from the Zoom chat.docx"
tags:
...
1.  The first thing you need to do is open the Zoom recording.
    ...
    ![](../../../images/open-source-spotlight/adding-links-from-the-zoom-chat/media/image4.jpg)
    <!-- sop-caption-start -->
...
2.  And then, click “Chat Messages” on the upper right of your screen
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/adding-links-from-the-zoom-chat/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  After, copy the links in the chat messages.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/adding-links-from-the-zoom-chat/media/image1.jpg)
    <!-- sop-caption-start -->
...
4.  And then, paste the links into the “Details” tab.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/open-source-spotlight/adding-links-from-the-zoom-chat/media/image3.jpg)
    <!-- sop-caption-start -->
