...
doc_type: sop
schema_version: 1
source: "Processes/Podcast/Moving Podcast Audio in Dropbox.docx"
tags:
  - podcast
systems:
  - spotify
...
1.  The first thing to do is to log in to [dropbox](https://www.dropbox.com/home?_tk=web_left_nav_bar&di=left_nav).
    ...
    ![](../../../images/podcast/moving-podcast-audio-in-dropbox/media/image1.png)
    <!-- sop-caption-start -->
...
2.  Click on “podcast” at the left sidebar.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/moving-podcast-audio-in-dropbox/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  Click on the “Edited” folder.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/moving-podcast-audio-in-dropbox/media/image4.png)
    <!-- sop-caption-start -->
...
4.  Click and drag the published podcast in Spotify from the “Edited” folder to “uploaded”.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/moving-podcast-audio-in-dropbox/media/image3.png)
    <!-- sop-caption-start -->
