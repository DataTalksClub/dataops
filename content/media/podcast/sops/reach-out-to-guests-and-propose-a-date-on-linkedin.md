...
doc_type: sop
schema_version: 1
source: "Processes/Podcast/Reach out to guests and propose a date on LinkedIn.docx"
tags:
  - podcast
systems:
  - linkedin
...
1.  The first thing you need to do is to contact the guest of the podcast on LinkedIn.
    ...
    ![](../../../images/podcast/reach-out-to-guests-and-propose-a-date-on-linkedin/media/image1.jpg)
    <!-- sop-caption-start -->
...
2.  Next, propose the date for the event, it can be seen on the DataTalks.Club schedule google spreadsheet.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/reach-out-to-guests-and-propose-a-date-on-linkedin/media/image3.jpg)
    <!-- sop-caption-start -->
...
3.  And then, enter the name of the guest in the google spreadsheet and write "proposed date”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/reach-out-to-guests-and-propose-a-date-on-linkedin/media/image2.jpg)
    <!-- sop-caption-start -->
...
4.  Lastly, send the proposed date to the guest
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/reach-out-to-guests-and-propose-a-date-on-linkedin/media/image4.jpg)
    <!-- sop-caption-start -->
