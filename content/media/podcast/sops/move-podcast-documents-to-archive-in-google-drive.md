...
doc_type: sop
schema_version: 1
source: "Processes/Podcast/Move podcast documents to archive in Google drive.docx"
tags:
  - podcast
systems:
  - loom
loom:
  - https://www.loom.com/share/f99b9151e0b0491a97fe62470d7e30d8
related_docs: []
---
...
1.  Open the “Events/[Podcast](https://drive.google.com/drive/folders/1NEm9zmr8W2zks5WIn0SOQMr6tWgZvy8D)” folder in the DTC files drive
    ...
    ![](../../../images/podcast/move-podcast-documents-to-archive-in-google-drive/media/image2.png)
    <!-- sop-caption-start -->
...
2.  Locate the relevant process document you want to move
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/move-podcast-documents-to-archive-in-google-drive/media/image1.png)
    <!-- sop-caption-start -->
...
3.  Next, drag the podcast document to the archive.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/move-podcast-documents-to-archive-in-google-drive/media/image3.png)
    <!-- sop-caption-start -->
    This screenshot matters for confirming the process is on the expected screen before the next action; look for the highlighted area or matching UI state shown in the image. Use it to verify the screen state, then complete the step described above.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
