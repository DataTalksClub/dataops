...
doc_type: sop
schema_version: 1
source: "Processes/Podcast/Add links to YouTube after the stream is over.docx"
tags:
  - podcast
systems:
  - linkedin
  ...
  - youtube
loom:
  - https://www.loom.com/share/c9044425dc104b71a77a9d149bdc7a01
related_docs: []
---
...
1.  The first thing you will need to do is reach out to the guest and ask for links that he wants to include.
    ...
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image7.jpg)
    <!-- sop-caption-start -->
...
2.  After, copy the link that the guest provided.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image6.jpg)
    <!-- sop-caption-start -->
...
3.  Next, open the youtube video and click on "Edit Video"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image2.jpg)
    <!-- sop-caption-start -->
...
4.  And then, paste the link you copied a while ago under "Description"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image1.jpg)
    <!-- sop-caption-start -->
...
5.  After, select the drag down button under "Playlists"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image5.jpg)
    <!-- sop-caption-start -->
...
6.  And check the playlist that this stream belongs to and click "Done"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image3.jpg)
    <!-- sop-caption-start -->
    This screenshot matters for confirming the process is on the expected screen before the next action; look for the highlighted area or matching UI state shown in the image. Use it to verify the screen state, then complete the step described above.
    <!-- sop-caption-end -->
    <!-- sop-screenshot-end -->
...
7.  Lastly, click "Save" on the top right of your screen
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/add-links-to-youtube-after-the-stream-is-over/media/image4.jpg)
    <!-- sop-caption-start -->
