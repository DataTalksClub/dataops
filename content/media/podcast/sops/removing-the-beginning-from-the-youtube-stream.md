...
doc_type: sop
schema_version: 1
source: "Processes/Podcast/Removing the beginning from the YouTube stream.docx"
tags:
  - podcast
systems:
  - loom
  - youtube
loom:
  - https://www.loom.com/share/0911a88a89cc48ac9a78e9e96dce6a9c
related_docs: []
---
...
1.  The first thing you need to do is select "Editor"
    ...
    ![](../../../images/podcast/removing-the-beginning-from-the-youtube-stream/media/image1.jpg)
    <!-- sop-caption-start -->
...
2.  In the editor, click “Trimming”
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/removing-the-beginning-from-the-youtube-stream/media/image2.jpg)
    <!-- sop-caption-start -->
...
3.  After, move the blue bar on the part you want to cut in the video.
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/removing-the-beginning-from-the-youtube-stream/media/image3.jpg)
    <!-- sop-caption-start -->
...
4.  Lastly, click "Save"
    ...
    <!-- sop-screenshot-start -->
    ![](../../../images/podcast/removing-the-beginning-from-the-youtube-stream/media/image4.jpg)
    <!-- sop-caption-start -->
